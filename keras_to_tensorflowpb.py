...
flags.DEFINE_string('output_nodes_prefix', 'my_output_node',
...
def load_model(input_model_path, input_json_path=None, input_yaml_path=None):
    custom_objects={"GlorotUniform": tf.keras.initializers.glorot_uniform,'hard_swish':hard_swish,'relu6':relu6}
...
def main(args):
    ...
    if FLAGS.quantize:
        ...
        transforms = ["quantize_weights", "quantize_nodes","add_default_attributes","fold_constants(ignore_errors=true)",\
                      "fold_batch_norms","fold_old_batch_norms","strip_unused_nodes","sort_by_execution_order"]
